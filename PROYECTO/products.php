                ...
                <div class="container">
                    ...
                    <div class="row" id="Container">
                        ...
                        $current_url = base64_encode("http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
                            ...
                            $results = $mysqli->query("SELECT * FROM producto ORDER BY id ASC");
                            if ($results) { 
                                        ...
                                        <div class="col-md-3 col-sm-6 mix portfolio-item Pizza">       
                                            <div class="portfolio-wrapper">                
                                                <div class="portfolio-thumb">
                                                    <img src="images/<?php echo $obj->product_img_name?>" alt="" />
                                                    <div class="hover">
                                                ...
                                                <div class="label-text">
                                                    <h3><a href="single-post.html"><?php echo $obj->product_name ?></a></h3>
                                                    <span class="text-category"><?php echo $currency.$obj->price ?></span>
                                                </div>
                                            </div>          
                                        </div>
                                    </form>
